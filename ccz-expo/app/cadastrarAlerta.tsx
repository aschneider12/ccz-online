...
const CadastroAlertaCczScreen = () => {
  ...
  const cadastrarAlerta = async () => {
    ...
    try {
      ...
      const response = await fetch(API_URLS.ALERTTA_CCZ.BASE, {
        method: 'POST',
        headers: {
    ...
    >
      ...
      >
        ...
        <View style={styles.form}>
            ...
            <Text style={styles.label}>Agente: {user?.nome}</Text>
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              ...
              placeholder="Descreva melhor o alerta para que a população fique ciente ou tome providências..."
...
export default CadastroAlertaCczScreen;